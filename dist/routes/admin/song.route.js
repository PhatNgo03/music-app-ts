...
router.post("/create", uploadMiddleware.fields([
    { name: "avatar", maxCount: 1 },
    { name: "audio", maxCount: 1 }
]), uploadCloud.uploadFields, song_validate_1.default.create, controller.createPost);
router.get("/edit/:id", controller.edit);
router.patch("/edit/:id", uploadMiddleware.fields([
    { name: "avatar", maxCount: 1 },
    { name: "audio", maxCount: 1 }
]), uploadCloud.uploadFields, song_validate_1.default.edit, controller.editPatch);
