...
router.post("/create", uploadMiddleware.single("avatar"), uploadCloud.upload, account_validate_1.default.create, controller.createPost);
router.get("/edit/:id", controller.edit);
router.patch("/edit/:id", uploadMiddleware.single("avatar"), uploadCloud.upload, account_validate_1.default.edit, controller.editPatch);
